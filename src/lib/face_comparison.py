...
class FaceComparison:
    ...
    def _process_image(self, image_path: str) -> Tuple[Optional[np.ndarray], Optional[List]]:
        ...
        try:
            ...
            # if faces[0].landmark_3d_68 is not None:
                # print(f"Found {len(faces[0].landmark_3d_68)} 3D landmarks for face")
                # print(f"Landmark shape: {faces[0].landmark_3d_68.shape}")
                """
